...
Этот элемент может инициировать (вызывать) различные [события](/ru/docs/Web/Events#media).
...
"[Основы стилизации видеопроигрывателя](/ru/docs/Web/Media/Audio_and_video_delivery/Video_player_styling_basics)" предоставляют некоторые полезные методы стилизации – они написаны в контексте {{HTMLElement("video")}}, но в значительной степени применимы и к `<audio>`.
...
- [Субтитры и скрытые субтитры](/ru/docs/Glossary/Plugin).
...
| [Категории контента](/ru/docs/Web/HTML/Content_categories) | [Потоковый контент](/ru/docs/Web/HTML/Content_categories#потоковый_контент), [фразовый контент](/ru/docs/Web/HTML/Content_categories#phrasing_content), [встроенный контент](/ru/docs/Web/HTML/Content_categories#встроенный_контент). Если элемент имеет атрибут `controls`, он так же принадлежит к категориям [интерактивного](/ru/docs/Web/HTML/Content_categories#интерактивный_контент) и [явного](/ru/docs/Web/HTML/Content_categories#явный_контент) контента.                                                                                                                     |
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Допустимое содержимое                                      | Если элемент имеет атрибут `src`: ноль или более элементов {{HTMLElement("track")}}, за которыми следует [прозрачный контентет](/ru/docs/Web/HTML/Content_categories#прозрачная_модель_контента), который не содержит элементов `<audio>` или {{HTMLElement("video")}}. Иначе: ноль или более элементов {{HTMLElement("source")}}, за которыми следует ноль или более элементов {{HTMLElement("track")}}, за которыми следует [прозрачный контент](/ru/docs/Web/HTML/Content_categories#прозрачная_модель_контента), который не содержит элементов `<audio>` или {{HTMLElement("video")}}. |
